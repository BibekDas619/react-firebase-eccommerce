...
class SignUp extends React.Component {
    ...
    handleSubmit = async event => {
        ...
        try {
            ...
            const userDoc = await createUserProfileDocument(user, { displayName })
        ...
        return (
            <div className='sign-up'>
                ...
                <form className='sign-up-form' onSubmit={this.handleSubmit}>
                    ...
                    <FormInput type='password' name='confirmPassword' value={this.state.disPlayName} onChange={this.handleChange} label='Confirm Password' required />
